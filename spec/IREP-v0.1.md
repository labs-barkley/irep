...
**DOI:** [to be assigned on Zenodo deposit]
...
Under the EU Artificial Intelligence Act, AI systems used in recruitment and selection are classified as high-risk, entailing obligations of risk management, data governance, documentation, human oversight and post-market monitoring. IREP is designed so that conformity is a property of the architecture rather than an afterthought: P4 (validated instruments), P5 (separation) and P7 (auditability) map directly onto those obligations. Implementers remain responsible for their own conformity assessment; the protocol provides the audit-ready skeleton. The same architecture serves GDPR data-minimization: category data is not collected until it has a lawful, specified purpose.
...
- Sumner, W. G. (1906). *Folkways*. Ginn and Company. [ethnocentrism]
...
- Additional cognitive-mechanism and repudiated-instrument references: see evidence/bibliography.md.
